...
Gem::Specification.new do |spec|
  spec.name          = "manageiq-providers-ibm_terraform"
  spec.version       = ManageIQ::Providers::IbmTerraform::VERSION
  spec.authors       = ["ManageIQ Authors"]

  spec.summary       = "ManageIQ plugin for the IBM Terraform provider."
  spec.description   = "ManageIQ plugin for the IBM Terraform provider."
